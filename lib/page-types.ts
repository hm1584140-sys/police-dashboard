...
export type PageRenderer = 'cms' | 'radio' | 'roster' | 'outfits' | 'strikes' | 'violations'
...
export const BUILTIN_PAGES: PageDefinition[] = [
  { id: 'builtin-sops', slug: 'sops', title: 'كتيب البروتوكولات', description: 'المرجع المعتمد للبروتوكولات والقواعد الداخلية.', icon: 'BookMarked', page_type: 'handbook', renderer: 'cms', is_visible: true, is_system: true, sort_order: 10, sector_id: null, blocks: [] },
